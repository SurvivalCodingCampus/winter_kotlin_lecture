...
//@Serializable
//data class Todo(val todoEntities: List<TodoEntities?>) {}



interface TodoDataSource {
    suspend fun getTodo(jsonData: String): List<Todo>?

}

class TodoManger : TodoDataSource {
    override suspend fun getTodo(jsonData: String): List<Todo> {
        return format.decodeFromString<List<Todo>>(jsonData)
    }
}
...
//    println(result)
    ...
    val result2 = TodoManger().getTodo(json2)
    println(result2)
}

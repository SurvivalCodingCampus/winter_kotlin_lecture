...
@Serializable
private data class GeoData(
    val lat: String,
    val lng: String
)


private object AddressSerializer : KSerializer<String> {
    override val descriptor = PrimitiveSerialDescriptor("Address", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): String {
        val addressJson = decoder.decodeSerializableValue(AddressData.serializer())

        return with(addressJson) {
            "[$zipcode] $city $suite $street (${geo.lat}, ${geo.lng})"
        }
    }

...
class MockCommentDataSourceImpl(jsonString: String? = null) : CommentDataSource {
    private val json = jsonString?.trimIndent() ?: """
[
{
"postId": 1,
"id": 1,
...
""".trimIndent()
    ...
    override suspend fun getComments(): List<Comment> {
        return try {
            defaultJson.decodeFromString<List<Comment>>(json)
        } catch (e: Exception) {
            throw e
        }
    }

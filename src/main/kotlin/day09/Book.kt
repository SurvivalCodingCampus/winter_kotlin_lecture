...
data class Book(
    ...
    private var publishedDateString: String = publishedDate.format(DateTimeFormatter.ofPattern("yyyy-MM-dd"))
    private var compareDate = publishedDateString.replace("-", "").toInt()
...
fun main() {
    val book1 = Book("나루토", "오다1", LocalDateTime.of(1999, 9, 9, 19, 50, 35))
    val book11 = Book("나루토", "오다11", LocalDateTime.of(1999, 9, 9, 12, 25, 15))
